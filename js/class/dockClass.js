...
function between(val, min, max) {
  ...
  class Dock {
    ...
    constructor(el) {
      ...
      this.iconSize = this.icons[0].offsetWidth + 28;
    ...
    scaleFromDirection(index, direction, offset) {
      ...
      if (icon.className.includes("btn-desktop")){
    ...
    adjustParentWidth() {
      ...
      this.icons.forEach(icon => {
        ...
        if (transform && transform !== 'none') {
          ...
          const transformedWidth = icon.offsetWidth * matrix.a;
      ...
      this.root.style.width = `${totalWidth + 100}px`;
    }
